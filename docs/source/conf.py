...
# -*- coding: utf-8 -*-
#
# dbgdb documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'dbgdb.tex', 'dbgdb Documentation',
     'Pat Daburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'dbgdb', 'dbgdb Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dbgdb', 'dbgdb Documentation',
     author, 'dbgdb', 'One line description of project.',
     'Miscellaneous'),
]
